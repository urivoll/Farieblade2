...
public class CerberusMelee : AbstractSpell
{
    ...
    public override IEnumerator HitEffect(Dictionary<string, int> inpData)
    {
        ...
        Instantiate(useSpell, _characterPlacement.CirclesMap[inpData["side"], inpData["place"]].newObject.pathBulletTarget.position, Quaternion.identity);
        _characterPlacement.CirclesMap[inpData["side"], inpData["place"]].newObject.SpellDamage(inpData["damage"], 5);
