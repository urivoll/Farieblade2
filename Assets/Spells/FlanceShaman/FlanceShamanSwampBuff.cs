...
public class FlanceShamanSwampBuff : AbstractSpell
{
    ...
    {
        UnitProperties targetUnit = _characterPlacement.CirclesMap[inpData["sideTarget"], inpData["placeTarget"]].ChildCharacter;
        Instantiate(Effect2, targetUnit.PathBulletTarget.position, Quaternion.identity);
        targetUnit.HpCharacter.SpellDamage(inpData["damage"], 3);
