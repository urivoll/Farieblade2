...
public class FatDemonSweep : AbstractSpell
{
    ...
    {
        yield return null;
        if (inpData.ContainsKey("damage")) _characterPlacement.CirclesMap[inpData["sideEnemy"], inpData["placeEnemy"]].ChildCharacter.HpCharacter.SpellDamage(inpData["damage"], 4);
    }
}
