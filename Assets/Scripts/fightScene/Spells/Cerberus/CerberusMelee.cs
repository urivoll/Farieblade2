...
public class CerberusMelee : AbstractSpell
{
    ...
    public override IEnumerator HitEffect(Dictionary<string, int> inpData)
    {
        ...
        Instantiate(useSpell, _characterPlacement.CirclesMap[inpData["side"], inpData["place"]].ChildCharacter.PathBulletTarget.position, Quaternion.identity);
        _characterPlacement.CirclesMap[inpData["side"], inpData["place"]].ChildCharacter.HpCharacter.SpellDamage(inpData["damage"], 5);
