...
public class RiderPassive : AbstractSpell
{
    ...
    {
        parentUnit.Animation.TryGetAnimation("spell");
        yield return new WaitForSeconds(0.2f);
        BattleSound.sound.PlayOneShot(swish);
        yield return new WaitForSeconds(0.1f);
        GameObject newObj = Instantiate(debuff, _characterPlacement.CirclesMap[inpData["sideTarget"], inpData["placeTarget"]].ChildCharacter.PathDebuffs);
